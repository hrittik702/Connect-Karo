    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      <div className="border-b border-ec-border pb-4">
        <h2 className="text-2xl font-medium text-ec-highlight capitalize flex items-center gap-2">
          <CreditCard size={20} className="text-ec-accent" />
          Billing & licensing
        </h2>
        <p className="text-xs text-ec-text-sub mt-0.5">Customize your node billing tiers, subscription contracts, and payment histories.</p>
      </div>
